...
/**
 * entities generated by other entities can leave them with objects implementing this interface. These classes should
 * make sure that all required actions are taken to implement the new entity into the game
...
public interface SpawnReceiver {
     ...
     * @see nl.NG.Jetfightergame.Rendering.Particles.Particles#explosion(PosVector, DirVector, Color4f, Color4f,
    ...
    /**
     * adds the given powerup type to the given jet
     * @param jet     any jet
     * @param newType the powerup obtained by the given jet
     */
